...
var i=e.Event("file_upload.beforeClear");this.input.trigger(i,[this]),i.result!==!1&&(this.resetFile(),this.input.val(""),this.resetPreview(), meeee_cust_file_reset(),this.input.trigger(e.Event("file_upload.afterClear"),[this]))
}else this.resetFile(),this.input.val(""), meeee_cust_file_reset(),this.resetPreview()
